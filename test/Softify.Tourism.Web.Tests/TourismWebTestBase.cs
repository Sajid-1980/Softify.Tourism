...
{
    public abstract class TourismWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TourismWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TourismWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TourismDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TourismDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TourismDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TourismDbContext, Task<T>> func)
        {
            T result;
