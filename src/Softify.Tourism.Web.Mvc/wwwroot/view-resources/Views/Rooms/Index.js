(function ($) {
    var _roleService = abp.services.app.room,
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <button type="button" class="btn btn-sm bg-secondary edit-role" data-role-id="${row.id}" data-toggle="modal" data-target="#RoomEditModal">`,
    ...
    $(document).on('click', '.edit-role', function (e) {
        ...
        e.preventDefault();
        abp.ajax({
            url: abp.appPath + 'Rooms/EditModal?roomId=' + roleId,
            type: 'POST',
            dataType: 'html',
