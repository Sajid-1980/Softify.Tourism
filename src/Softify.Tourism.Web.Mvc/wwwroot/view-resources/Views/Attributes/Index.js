(function ($) {
    var _roleService = abp.services.app.attribute,
        l = abp.localization.getSource('Tourism'),
        _$modal = $('#AttributesCreateModal'),
        _$form = _$modal.find('form'),
        _$table = $('#AttributesTable');
    ...
    var _$rolesTable = _$table.DataTable({
        ...
        listAction: {
            ...
            inputFilter: function () {
                return $('#AttributesSearchForm').serializeFormToObject(true);
            }
        },
        buttons: [
            {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <button type="button" class="btn btn-sm bg-secondary edit-role" data-role-id="${row.id}" data-toggle="modal" data-target="#AttributesEditModal">`,
    ...
    $(document).on('click', '.edit-role', function (e) {
        ...
        e.preventDefault();
        abp.ajax({
            url: abp.appPath + 'Attributes/EditModal?attributeId=' + roleId,
            type: 'POST',
            dataType: 'html',
            success: function (content) {
                $('#AttributesEditModal div.modal-content').html(content);
            },
            error: function (e) {
            }
        })
