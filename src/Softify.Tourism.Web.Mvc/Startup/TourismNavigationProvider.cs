...
namespace Softify.Tourism.Web.Startup
{
    ...
    /// </summary>
    public class TourismNavigationProvider : NavigationProvider
    {
            ...
            context.Manager.MainMenu
                ...
                .AddItem(
                    ...
                    new MenuItemDefinition(
                        ...
                        permissionDependency: new SimplePermissionDependency(PermissionNames.Pages_Services)
                    )
                )
                .AddItem(
                    new MenuItemDefinition(
                        PageNames.Attributes,
                        L("Attributes"),
                        url: "Attributes",
                        icon: "fab fa-autoprefixer\t",
                        permissionDependency: new SimplePermissionDependency(PermissionNames.Pages_Attributes)
                    )
                ).AddItem(
                    new MenuItemDefinition(
                        PageNames.Users,
